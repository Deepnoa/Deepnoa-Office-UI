...
![Deepnoa Office UI カバー](docs/screenshots/readme-cover-2.jpg)
...
```text
この SKILL.md に従って Deepnoa Office UI をデプロイしてください：
...
```bash
# 1) リポジトリをクローン
git clone <your-deepnoa-office-ui-repo>
cd Deepnoa-Office-UI
