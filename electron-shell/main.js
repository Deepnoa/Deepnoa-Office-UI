...
const APP_NAME = "Deepnoa Office UI";
...
function findProjectRoot() {
  ...
  const candidates = [
    path.join(home, "Documents", "GitHub", "Deepnoa-Office-UI"),
    path.join(home, "GitHub", "Deepnoa-Office-UI"),
    path.join(home, "Documents", "Deepnoa-Office-UI"),
    path.join(home, "Deepnoa-Office-UI"),
...
function createWindows(projectRoot) {
  ...
  miniWindow.setTitle("Deepnoa Office UI Mini");
