# Deepnoa Office Tauri Desktop Shell

这个目录用于把 `Deepnoa-Office-UI` 包成桌面应用（透明窗口），并在启动时自动拉起后端进程。
...
```bash
cd /Users/wangzhaohan/Documents/GitHub/Deepnoa-Office-UI
uv venv .venv
...
```bash
cd /Users/wangzhaohan/Documents/GitHub/Deepnoa-Office-UI/desktop-pet
npm install
npm run dev
```
