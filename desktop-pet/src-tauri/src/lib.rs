...
fn find_project_root() -> PathBuf {
    ...
    if let Ok(home) = std::env::var("HOME") {
        ...
        let candidates = [
            home.join("Documents").join("GitHub").join("Deepnoa-Office-UI"),
            home.join("GitHub").join("Deepnoa-Office-UI"),
            home.join("Documents").join("Deepnoa-Office-UI"),
            home.join("Deepnoa-Office-UI"),
